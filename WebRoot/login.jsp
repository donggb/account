    ...
    <div class="container">
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                <form class="form-horizontal" action="123" method="post">
                    <span class="heading">登录/注册</span>
                    ...
                    <div class="form-group">
                        <button type="button" id="getCode" class="main-checkbox" onclick="sendMessage()"></button>
                        <span class="text">获取验证码 点击后60秒一次</span>
